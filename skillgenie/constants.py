...
# Health thresholds
HEALTH_EXCELLENT_THRESHOLD = 0.90
HEALTH_GOOD_THRESHOLD = 0.75
HEALTH_FAIR_THRESHOLD = 0.50
HEALTH_POOR_THRESHOLD = 0.25

# Recommendation weights
RECOMMENDATION_SIMILARITY_WEIGHT = 0.55
RECOMMENDATION_CONFIDENCE_WEIGHT = 0.25
RECOMMENDATION_QUALITY_WEIGHT = 0.20
